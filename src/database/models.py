...
def init_tables(engine):
    ...
    global type_table, api_credential_table, client_table, role_table, users_table
    ...
    try:
        ...
        api_credential_table = Table('api_credential', metadata, schema="sensors", autoload_with=engine)
